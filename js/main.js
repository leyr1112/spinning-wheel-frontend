		...
		slices: [
			{
				...
				value: 12,
				message: "<img src='https://spinning-wheel-frontend.vercel.app/images/btc.png' style='margin-bottom: 0px; margin-right: 6px; width: 24px'/>1 BTC",
				background: "#f4bc2188",
			},
			{
				...
				value: 8,
				message: "<img src='https://spinning-wheel-frontend.vercel.app/images/s2k.png' style='margin-bottom: 0px; margin-right: 6px; width: 24px'/>5,000,000 S2K",
			...
			},
			{
				...
				value: 3,
				message: "<img src='https://spinning-wheel-frontend.vercel.app/images/busd.png' style='margin-bottom: 0px; margin-right: 6px; width: 24px'/>100 BUSD",
				background: "transparent",
			},
			{
			...
			},
			{
				...
				value: 2,
				message: "<img src='https://spinning-wheel-frontend.vercel.app/images/bnb.png' style='margin-bottom: 0px; margin-right: 6px; width: 24px'/>1 BNB",
				background: "transparent",
			},
			{
				text: "<div>100 BUSD</div><img src='https://spinning-wheel-frontend.vercel.app/images/busd.png' style='margin-left: 6px; max-width: 18%;'/>",
			...
			},
			{
				...
				value: 7,
				message: "<img src='https://spinning-wheel-frontend.vercel.app/images/s2k.png' style='margin-bottom: 0px; margin-right: 6px; width: 24px'/>80,000,000 S2K",
				background: "transparent",
			},
			{
				text: "<div>200 SOG</div><img src='https://spinning-wheel-frontend.vercel.app/images/sog.png' style='margin-left: 6px; max-width: 18%;'/>",
				value: 10,
				message: "<img src='https://spinning-wheel-frontend.vercel.app/images/sog.png' style='margin-bottom: 0px; margin-right: 6px; width: 24px'/>200 SOG",
				background: "transparent",
			},
			{
				...
				value: 6,
				message: "<img src='https://spinning-wheel-frontend.vercel.app/images/s2k.png' style='margin-bottom: 0px; margin-right: 6px; width: 24px'/>10,000,000,000 S2K",
				background: "transparent",
			},
			{
				...
				value: 5,
				message: "<img src='https://spinning-wheel-frontend.vercel.app/images/doge.png' style='margin-bottom: 0px; margin-right: 6px; width: 24px'/>100 DOGE",
				background: "transparent",
			},
			{
				...
				value: 1,
				message: "<img src='https://spinning-wheel-frontend.vercel.app/images/eth.png' style='margin-bottom: 0px; margin-right: 6px; width: 24px'/>1 ETH",
				background: "transparent",
			},
			{
				...
				value: 9,
				message: "<img src='https://spinning-wheel-frontend.vercel.app/images/sog.png' style='margin-bottom: 0px; margin-right: 6px; width: 24px'/>1,000 SOG",
				background: "transparent",
			},
		],
		text: {
